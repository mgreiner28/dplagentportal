...
class InternalNotificationsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.internal_notifications.create', $relations);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.internal_notifications.edit', compact('internal_notification') + $relations);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.internal_notifications.show', compact('internal_notification') + $relations);
    }
